...
CONSTANT = {
	RESTRICTED_PEDS = {
		...
		[GetHashKey("a_m_m_tranvest_01")] = 1,
		[GetHashKey("a_m_m_tranvest_02")] = 1,
		[GetHashKey("a_m_o_acult_01")] = 1,
		[GetHashKey("a_m_y_acult_01")] = 1,
		[GetHashKey("csb_stripper_01")] = 1,
		[GetHashKey("csb_stripper_02")] = 1,
		[GetHashKey("mp_f_deadhooker")] = 1,
		[GetHashKey("mp_f_stripperlite")] = 1,
		[GetHashKey("s_f_y_hooker_01")] = 1,
		[GetHashKey("s_f_y_hooker_02")] = 1,
		[GetHashKey("s_f_y_hooker_03")] = 1,
		...
		[GetHashKey("g_f_y_lost_01")] = 2,
		[GetHashKey("mp_f_cocaine_01")] = 2,
		[GetHashKey("mp_m_cocaine_01")] = 2,
		[GetHashKey("s_f_y_bartender_01")] = 2,
		[GetHashKey("u_f_y_danceburl_01")] = 2,
		[GetHashKey("u_f_y_dancerave_01")] = 2,
		[GetHashKey("u_m_y_danceburl_01")] = 2
	},
