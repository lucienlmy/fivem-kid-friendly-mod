...
-- CONTENT FILTER PROFILE: reduced gore and disturbing content with harmless weapons --------------
---------------------------------------------------------------------------------------------------
...
--	Non-player characters
	NPC = {
		...
		ignore_players = 1, -- 0 = Normal reactions to players, 1 = Ignore low-priority player disturbances, 2 = Strongly ignore player activity
		...
		replace_peds = 2 -- 0 = Off, 1 = Replace all NPC, 2 = Replace disturbing and minimal clothing NPCs only. Replace NPC models with random models from the SPAWN_ITEMS.PEDS list
	},
	
--	Police NPCs
	POLICE = {
		max_wanted_level = 0, -- 0 to 6. Sets the max wanted level for players
...
--	Weapons
	WEAPONS = {
		...
		remove_all_weapons = 1, -- 0 = NPCs and Players can have weapons, 1 = NPC weapons removed, 2 = NPC and Player weapons removed
		...
		-- Vehicle weapons
		disable_vehicle_weapons = 2, -- 0 = No vehicle weapons are disabled, 1 = Allow permitted vehicles only (listed below), 2 = Disable all vehicle weapons
...
--	Vehicles
	VEHICLES = {
		...
		spawn_density_multiplier_scenario = 0.8, -- 0.0 to 1.0. Controls number of vehicle scenarios (NPCs driving etc)
		...
		keep_clean = 2, -- 0 = No change, 1 = Cleans dirt (inc blood) on player occupied vehicles every 10sec, 2 = Dirt cleaned on all vehicles
...
--	Time, weather, blood pooling, ambient sounds and door locks
	WORLD = {
		...
		lock_adult_doors = true, -- Prevents doors from opening to interiors listed in WORLD.interiors_doors_to_restrict
