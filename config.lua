...
--	Non-player characters
	NPC = {
		...
		ignore_players = 2, -- 0 = Normal reactions to players, 1 = Ignore low-priority player disturbances, 2 = Strongly ignore player activity
		prevent_fleeing = true, -- Prevents on-foot NPCs from fleeing, regardless of what caused the reaction
